...
<body>
  ...
  <div class="container mt-5">
    <div class="row mt-5">
      <div class="col-3"></div>
      <div class="col-6">
        <form class='card Regular shadow p-4' method='POST' action="{{route('createStudent')}}" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group mb-1">
            <span>photo:</span>
            <input type="file" name='photo'  id="exampleInputPassword1" >
            <br>@error('photo')
              <span class="text-danger">{{$message}}</span>
            @enderror
          </div>
